...
import 'package:sawo/Widgets/barcode_detail.dart';
import 'package:sawo/Widgets/face_detail.dart';
import 'package:sawo/Widgets/ocr_text_detail.dart';
// import 'package:sawo_final/Widget/CustomListTile.dart';
// import 'package:sawo_final/Widget/barcode_detail.dart';
// import 'package:sawo_final/Widget/face_detail.dart';
// import 'package:sawo_final/Widget/ocr_text_detail.dart';
import 'loginPage.dart';

class Home_1_Screen extends StatefulWidget {
  @override
  _Home_1_Screen createState() => _Home_1_Screen();
}
class _Home_1_Screen extends State<Home_1_Screen> {
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [Tab(text: 'Barcode'), Tab(text: 'OCR')],
            ),
